...
function authorizeTransitionByRole(currentStatus, nextStatus, userRole) {
  ...
  const ownerPermitted = [
    ...
    { from: REPAIR_REQUEST_STATUS.PUBLISHED, to: [REPAIR_REQUEST_STATUS.MATCHING_TECHNICIANS, REPAIR_REQUEST_STATUS.AWAITING_QUOTATIONS, REPAIR_REQUEST_STATUS.CANCELLED, REPAIR_REQUEST_STATUS.DONATION_OFFERED] },
    { from: REPAIR_REQUEST_STATUS.MATCHING_TECHNICIANS, to: [REPAIR_REQUEST_STATUS.AWAITING_QUOTATIONS, REPAIR_REQUEST_STATUS.CANCELLED] },
    { from: REPAIR_REQUEST_STATUS.AWAITING_QUOTATIONS, to: [REPAIR_REQUEST_STATUS.CANCELLED] },
